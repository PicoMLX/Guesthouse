...
/// The trusted coordinator supplies validated callbacks and executes returned effects.
/// This public value API performs no runtime inspection, persistence, or host mutation.
///
