...
extension Redactor {
    ...
    struct Patterns: @unchecked Sendable {
        ...
        let terminalEscape = #/(?:\u{1B}\]|\u{9D})[^\u{07}\u{18}\u{1A}\u{9C}\u{1B}]*(?:[\u{07}\u{18}\u{1A}\u{9C}]|\u{1B}\\)?|(?:\u{1B}[P_^X]|[\u{90}\u{9F}\u{9E}\u{98}])[^\u{18}\u{1A}\u{9C}\u{1B}]*(?:[\u{18}\u{1A}\u{9C}]|\u{1B}\\)?|(?:\u{1B}\[|\u{9B})[0-9;:?<=>]*[ -\/]*[@-~]|\u{1B}[ -\/]*[0-~]|[\u{00}-\u{08}\u{0B}\u{0C}\u{0E}-\u{1F}\u{7F}-\u{9F}]/#
