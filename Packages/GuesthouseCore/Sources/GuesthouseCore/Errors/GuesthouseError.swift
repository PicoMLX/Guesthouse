...
public enum GuesthouseError: Error, Codable, Hashable, Sendable {
    ...
    public var recoveryActions: [RecoveryAction] {
        ...
        case .toolMismatch(.ssh): [.repair(.tools), .openConsole, .cancel]
        ...
        case .operationOutcomeUnknown, .canceled: [.inspectState, .cancel]
        case .invalidRequest(.invalidVMName): [.editEnvironmentName, .cancel]
        case .invalidRequest(.pathEscapesAllowedRoot): [.chooseAllowedLocation, .cancel]
